...
{
	#ifndef MESS
	mame_printf_info("A.G.E. v" AGEVER "/"APPLONGNAME" v%s - Multiple Arcade Machine Emulator\n"
			"Copyright (C) 1997-2007 by Nicola Salmoria and the MAME Team\n",build_version);
	mame_printf_info("Arcade Gambling Extension (A.G.E) v"AGEVER"\n"
			"Copyright (C) 2004-2007 by J. Wallace and the AGEMAME Development Team\n\n");
	mame_printf_info("%s\n", mame_disclaimer);
	mame_printf_info("Usage:  age gamename [options]\n\n"
